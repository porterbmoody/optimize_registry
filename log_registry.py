...
class Registry:
    ...
    def open_log(self, log_number):
        ...
        self.delimiter = """||"""
        self.headers = f"""root{self.delimiter}subkey{self.delimiter}count{self.delimiter}subsubkey{self.delimiter}subsubkey_count{self.delimiter}subsubsubkey{self.delimiter}subsubsubkey_count{self.delimiter}subsubsubsubkey{self.delimiter}subsubsubsubkey_count\n"""
        self.log_file.write(self.headers)
    ...
    def open_hives(self):
        ...
        for hkey_name in self.data['hkeys']:
            try:
                ...
                hive = winreg.ConnectRegistry(None, hkey_const)
                            ...
                            for subsubkey_number in range(subsubkey_count):
                                try:
                                    ...
                                    if subsubsubkey_count == 0:
                                        ...
                                        self.log_file.write(f"""{hive[0]}{self.delimiter}{subkey_name}{self.delimiter}{subkey_count}{self.delimiter}{subsubkey_name}{self.delimiter}{subsubkey_count}{self.delimiter}{subsubsubkey_name}{self.delimiter}{subsubsubkey_count}{self.delimiter}{'none'}{self.delimiter}{'none'}\n""")
                                    else:
                                        for subsubsubkey_number in range(subsubsubkey_count):
                                            try:
                                                ...
                                                log_string = f"""{hive[0]}{self.delimiter}{subkey_name}{self.delimiter}{subkey_count}{self.delimiter}{subsubkey_name}{self.delimiter}{subsubkey_count}{self.delimiter}{subsubsubkey_name}{self.delimiter}{subsubsubkey_count}{self.delimiter}{subsubsubsubkey_name}{self.delimiter}{subsubsubsubkey_count}\n"""
                                                print(log_string)
